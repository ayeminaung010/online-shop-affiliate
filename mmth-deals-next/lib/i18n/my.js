...
const my = {
    // ── App ──
    'app.title': 'MMTH Deals',
    'app.copyright': '© {year} MMTH Deals. မူပိုင်ခွင့်များအားလုံး ရယူထားသည်။',

    // ── Hero ──
    'hero.trust': 'စစ်ဆေးပြီးသော Affiliate လင့်ခ်များ',
    'hero.title': 'MMTH Deals',
    ...
    'footer.affiliate': 'ဤပလက်ဖောင်းသည် affiliate deals များကို စုစည်းပေးထားပါသည်။ ဤလင့်ခ်များမှတစ်ဆင့် ဝယ်ယူပါက သင့်အတွက် အပိုကုန်ကျစရိတ်မရှိဘဲ ကျွန်ုပ်တို့ ကော်မရှင်ရရှိနိုင်ပါသည်။',
